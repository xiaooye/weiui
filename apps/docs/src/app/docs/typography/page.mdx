...
|-------|-------|-------------|
| `--wui-line-height-tight` | 1.15 | Headings and display text — tight vertical rhythm |
| `--wui-line-height-snug` | 1.35 | UI text, labels, buttons |
| `--wui-line-height-normal` | 1.5 | Body copy — comfortable reading |
| `--wui-line-height-relaxed` | 1.75 | Long-form prose, dense lists |

## Letter spacing

| Token | Value | Use |
|-------|-------|-----|
| `--wui-tracking-tight` | `-0.02em` | Display-size headings |
| `--wui-tracking-normal` | `0` | Body text |
| `--wui-tracking-wide` | `0.02em` | All-caps eyebrows and overlines |
