...
import { ProgressBar } from "civaria";
...
export function ProgressBarDemo() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "var(--civ-spacing-4)", width: "100%", maxWidth: "480px" }}>
      <div>
        <p style={{ margin: 0, marginBlockEnd: "var(--civ-spacing-2)", fontSize: "var(--civ-font-size-sm)", color: "var(--civ-color-muted-foreground)" }}>
