...
import { Heading, Link, Stack } from "civaria";
...
export function TableOfContents() {
  ...
  return (
    <nav className="civ-docs-toc" aria-label="On this page">
      <Heading level={4} className="civ-docs-toc__title">
        On this page
      </Heading>
      <Stack direction="column" gap={0} role="list" className="civ-docs-toc__list">
        {headings.map((h) => (
          <Link
            key={h.id}
            href={`#${h.id}`}
