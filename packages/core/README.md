...
Framework-neutral behavior and semantic contracts for WeiUI. This package contains no React, Vue, Solid or Svelte imports and is safe to import during SSR.
